...
describe EventDecorator do
  ...
  let(:model)     { build_stubbed :event, name: 'Foo bar', description: 'Bla', scheduled_at: DateTime.new(2013, 3, 1, 12) }
  ...
  it "applies markdown to description" do
    expect(event.description).to eql("<p>Bla</p>\n")
  end
end
